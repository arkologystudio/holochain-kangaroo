...
const APP_NAME: &str = "data-commons-mvp"; // name of the app. Can be changed without breaking your app.
const APP_ID: &str = "data-commons-mvp.0.0.1"; // App id used to install your app in the Holochain conductor - can be the same as APP_NAME. Changing this means a breaking change to your app.
pub const WINDOW_TITLE: &str = "data-commons-mvp"; // Title of the window
